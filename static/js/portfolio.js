...
;( function( window ) {
	...
	CBPGridGallery.prototype._init = function() {
		...
		this.ctrlPrev = this.el.querySelector( 'section.slideshow > nav > span.fa-chevron-left' );
		this.ctrlNext = this.el.querySelector( 'section.slideshow > nav > span.fa-chevron-right' );
